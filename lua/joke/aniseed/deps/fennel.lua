package.preload["joke.aniseed.fennel.repl"] = package.preload["joke.aniseed.fennel.repl"] or function(...)
  local utils = require("joke.aniseed.fennel.utils")
  local parser = require("joke.aniseed.fennel.parser")
  local compiler = require("joke.aniseed.fennel.compiler")
  local specials = require("joke.aniseed.fennel.specials")
  local view = require("joke.aniseed.fennel.view")
...
package.preload["joke.aniseed.fennel.specials"] = package.preload["joke.aniseed.fennel.specials"] or function(...)
  local utils = require("joke.aniseed.fennel.utils")
  local view = require("joke.aniseed.fennel.view")
  local parser = require("joke.aniseed.fennel.parser")
  local compiler = require("joke.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "joke.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["joke.aniseed.fennel.compiler"] = package.preload["joke.aniseed.fennel.compiler"] or function(...)
  local utils = require("joke.aniseed.fennel.utils")
  local parser = require("joke.aniseed.fennel.parser")
  local friend = require("joke.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["joke.aniseed.fennel.friend"] = package.preload["joke.aniseed.fennel.friend"] or function(...)
  local utils = require("joke.aniseed.fennel.utils")
...
package.preload["joke.aniseed.fennel.parser"] = package.preload["joke.aniseed.fennel.parser"] or function(...)
  local utils = require("joke.aniseed.fennel.utils")
  local friend = require("joke.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["joke.aniseed.fennel.view"] = package.preload["joke.aniseed.fennel.view"] or function(...)
...
package.preload["joke.aniseed.fennel.utils"] = package.preload["joke.aniseed.fennel.utils"] or function(...)
  local view = require("joke.aniseed.fennel.view")
  local version = "1.1.0"
...
utils = require("joke.aniseed.fennel.utils")
local parser = require("joke.aniseed.fennel.parser")
local compiler = require("joke.aniseed.fennel.compiler")
local specials = require("joke.aniseed.fennel.specials")
local repl = require("joke.aniseed.fennel.repl")
local view = require("joke.aniseed.fennel.view")
...
do
  ...
  local module_name = "joke.aniseed.fennel.macros"
  local _
