...
local _2amodule_name_2a = "joke.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("joke.aniseed.compile"), autoload("joke.aniseed.fennel"), autoload("joke.aniseed.fs"), autoload("joke.aniseed.nvim")
