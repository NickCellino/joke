...
local _2amodule_name_2a = "joke.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("joke.aniseed.core"), autoload("joke.aniseed.compile"), autoload("joke.aniseed.fennel"), autoload("joke.aniseed.fs"), autoload("joke.aniseed.nvim")
