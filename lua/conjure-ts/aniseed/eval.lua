...
local _2amodule_name_2a = "conjure-ts.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("conjure-ts.aniseed.core"), autoload("conjure-ts.aniseed.compile"), autoload("conjure-ts.aniseed.fennel"), autoload("conjure-ts.aniseed.fs"), autoload("conjure-ts.aniseed.nvim")
